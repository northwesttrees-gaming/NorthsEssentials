...
public class NorthsessentialsModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> ELEVATOR_BLOCK = register("elevator_block", NorthsessentialsModBlocks.ELEVATOR_BLOCK, ElevatorBlockBlockEntity::new);
