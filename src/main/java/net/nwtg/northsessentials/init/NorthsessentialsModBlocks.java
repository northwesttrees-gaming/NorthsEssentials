...
import net.nwtg.northsessentials.block.WarpedElevatorBlockBlock;
import net.nwtg.northsessentials.block.SpruceElevatorBlockBlock;
...
import net.nwtg.northsessentials.block.OakElevatorBlockBlock;
...
import net.nwtg.northsessentials.block.MangroveElevatorBlockBlock;
import net.nwtg.northsessentials.block.LapisNodeBlock;
import net.nwtg.northsessentials.block.LapisDeepslateNodeBlock;
import net.nwtg.northsessentials.block.JungleElevatorBlockBlock;
...
import net.nwtg.northsessentials.block.DarkOakElevatorBlockBlock;
import net.nwtg.northsessentials.block.CrimsonElevatorBlockBlock;
...
import net.nwtg.northsessentials.block.BirchElevatorBlockBlock;
...
import net.nwtg.northsessentials.block.AcaciaElevatorBlockBlock;
...
public class NorthsessentialsModBlocks {
	...
	public static final RegistryObject<Block> OAK_ELEVATOR_BLOCK = REGISTRY.register("oak_elevator_block", () -> new OakElevatorBlockBlock());
	public static final RegistryObject<Block> SPRUCE_ELEVATOR_BLOCK = REGISTRY.register("spruce_elevator_block", () -> new SpruceElevatorBlockBlock());
	public static final RegistryObject<Block> BIRCH_ELEVATOR_BLOCK = REGISTRY.register("birch_elevator_block", () -> new BirchElevatorBlockBlock());
	public static final RegistryObject<Block> JUNGLE_ELEVATOR_BLOCK = REGISTRY.register("jungle_elevator_block", () -> new JungleElevatorBlockBlock());
	public static final RegistryObject<Block> ACACIA_ELEVATOR_BLOCK = REGISTRY.register("acacia_elevator_block", () -> new AcaciaElevatorBlockBlock());
	public static final RegistryObject<Block> DARK_OAK_ELEVATOR_BLOCK = REGISTRY.register("dark_oak_elevator_block", () -> new DarkOakElevatorBlockBlock());
	public static final RegistryObject<Block> CRIMSON_ELEVATOR_BLOCK = REGISTRY.register("crimson_elevator_block", () -> new CrimsonElevatorBlockBlock());
	public static final RegistryObject<Block> WARPED_ELEVATOR_BLOCK = REGISTRY.register("warped_elevator_block", () -> new WarpedElevatorBlockBlock());
	public static final RegistryObject<Block> MANGROVE_ELEVATOR_BLOCK = REGISTRY.register("mangrove_elevator_block", () -> new MangroveElevatorBlockBlock());
}
